...
using Avalonia.NameGenerator.VisualBasic.Compiler;
using Avalonia.NameGenerator.VisualBasic.Domain;
using Avalonia.NameGenerator.VisualBasic.Generator;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.VisualBasic;

[assembly: InternalsVisibleTo("Avalonia.NameGenerator.VisualBasic.Tests")]

namespace Avalonia.NameGenerator.VisualBasic;
...
public class AvaloniaNameSourceGenerator : ISourceGenerator
{
    ...
    private static INameGenerator CreateNameGenerator(GeneratorExecutionContext context)
    {
        ...
        var types = new RoslynTypeSystem((VisualBasicCompilation)context.Compilation);
